...
public class CallListContactDetails extends Activity 
{
	Bitmap bm;
	TelephonyManager tm;
...
InputStream is = null;
	   ...
	   showdetails=(TableLayout)findViewById(R.id.table);
		...
		btntask.setOnClickListener(new Button.OnClickListener()  
       	{ 
       		...
       		{ 
           		Intent i=new Intent(CallListContactDetails.this,ViewTaskDetails.class);
		...
		btnnotes.setOnClickListener(new Button.OnClickListener()   
       	{ 
           	...
           	public void onClick (View v)
       		{ 
           		Intent i3=new Intent(CallListContactDetails.this,ViewNotesDetails.class);
	...
	purpose:sets data to widgets*/
	 ...
	 /*Type :class
		name:mPhoneListener
		date:10-2-12
		purpose:overrides PhoneListener class mehtods*/ 
	 private PhoneStateListener mPhoneListener = new PhoneStateListener() 
		{
			...
			public void onCallStateChanged(int state, String Number) 
			{
				 ...
				 if (called && state == TelephonyManager.CALL_STATE_IDLE) 
				 {
		                ...
		                try {
		                    CallListContactDetails.this.finish();
							...
							if(flag==1)
							{
							Intent i = new Intent(CallListContactDetails.this,UpdateStatusCallListContactsDetails.class);
							Bundle bun=new Bundle();
							...
							{
								Intent i=new Intent(CallListContactDetails.this,CallListContactDetails.class);
								i.setAction(Intent.ACTION_MAIN);
								Bundle bun=new Bundle();
	...
	{
		Intent i=new Intent(CallListContactDetails.this,DisplayCallList.class);
		Bundle bun=new Bundle();
