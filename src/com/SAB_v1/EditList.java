...
{	
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		listname1  = bundle.getString("listname");
		System.out.println("My id will ......"+listname1);
		id1=Integer.parseInt(listname1);
			System.out.println("Cll id will......"+id1);
		getcontacts();
		...
		{      
			...
			{
				Task task = new Task();
        		task.applicationContext = EditList.this;
        		task.execute();
		...
		ok.setOnClickListener(new OnClickListener() 
		{
			public void onClick(View v) 
			{
				...
				Intent i=new Intent(EditList.this,DisplayCallList.class);
				Bundle bun=new Bundle();
				bun.putString("id",listname1);
				  ...
				  String img=results3.get(position);
				  	...
				  	ch.setOnClickListener( new OnClickListener() 
				  	{
						...
						public void onClick(View v) 
						{
							...
							Cursor c1=data.validate_calllist(id1,callid1);
							...
							{							
								data.InsertCallList(id1,callid1);
							}
							  
							   System.out.println("iddd... "+id1);
							   System.out.println("callid1... "+callid1);		
							   //Toast.makeText(EditList.this, "Contact id and list id will "+id1+" "+callid1,Toast.LENGTH_SHORT).show();
				  ...
				  String img=results7.get(position);
				  	...
				  	ch.setOnClickListener( new OnClickListener()
				  	{
						...
						public void onClick(View v) 
						{
							...
							Cursor c1=data.validate_calllist(id1,call);
							int count=c1.getCount();
							if(count>0)
							{
								call();
	...
	public void call()
	{
		Toast.makeText(EditList.this, "Contact already added to this CallList", Toast.LENGTH_LONG);
	}
