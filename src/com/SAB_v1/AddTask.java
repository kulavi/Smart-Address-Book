		...
		ddone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				if(flag==1)
				{
					...
					{
						final AlertDialog.Builder alertbox1=new AlertDialog.Builder(AddTask.this);
	            ...
	            // set a positive/yes button and create a listener
	                ...
	                // do something when the button is clicked
							public void onClick(DialogInterface arg0, int arg1)
							{
								...
								data.Inserttask(name3,taskname, descrip,"low",sdate, ddate,stime, cid,locname);
		          			    Toast.makeText(AddTask.this, "Task Added Successfully",Toast.LENGTH_SHORT).show();
		          			    
		          			    //sets alarm to remind about tasks 
		          		      ...
		          		      Intent i = new Intent(AddTask.this,DisplayNotification.class);
		          		      ...
		          		      alarmManager.set(AlarmManager.RTC_WAKEUP, 
		                    	 ...
		                    	 Intent i1 =new Intent(AddTask.this,UpdateStatus.class);
		...
		protected void onPostExecute(Void unused) {
			...
			System.out.println("IN PostExecute");
		      ...
		      try { 
		        ...
		        if(m.send()) { 
		          Toast.makeText(AddTask.this, "Email was sent successfully.", Toast.LENGTH_LONG).show();
		          
		          } else { 
		          Toast.makeText(AddTask.this, "Email was not sent.", Toast.LENGTH_LONG).show(); 
		        } 
		      } catch(Exception e) { 
	...
	public void email_alert()
	{
		final AlertDialog.Builder alertbox=new AlertDialog.Builder(this);
                ...
                alertbox.setPositiveButton("Yes", new DialogInterface.OnClickListener() 
                {
                    ...
                    {
                    	Task task = new Task();
                		task.applicationContext = AddTask.this;
                		task.execute();
