...
public class AddTaskContactDetails extends Activity implements OnClickListener
{
	DataBaseHelper data;
	EditText edescp,loc;
		...
		ddone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				if(flag==1)
				{
					...
					{
						final AlertDialog.Builder alertbox1=new AlertDialog.Builder(AddTaskContactDetails.this);
	                ...
	                // do something when the button is clicked
							public void onClick(DialogInterface arg0, int arg1)
							{
								...
								data.Inserttask(name3,taskname,descrip,ans,sdate,ddate,stime,cid,locname);
		          			    Toast.makeText(AddTaskContactDetails.this, "Task Added Successfully",Toast.LENGTH_SHORT).show();
		          		      ...
		          		      Intent i = new Intent(AddTaskContactDetails.this,DisplayNotification.class);
		          		      ...
		          		      alarmManager.set(AlarmManager.RTC_WAKEUP, 
		                    	 ...
		                    	 Intent i1 =new Intent(AddTaskContactDetails.this,UpdateStatusContactsDetails.class);
		...
		protected void onPostExecute(Void unused) {
			...
			System.out.println("IN PostExecute");
		      ...
		      try { 
		        ...
		        if(m.send()) { 
		          Toast.makeText(AddTaskContactDetails.this, "Email was sent successfully.", Toast.LENGTH_LONG).show();
		          
		          } else { 
		          Toast.makeText(AddTaskContactDetails.this, "Email was not sent.", Toast.LENGTH_LONG).show(); 
		        } 
		      } catch(Exception e) { 
	...
	public void email_alert()
	{
		final AlertDialog.Builder alertbox=new AlertDialog.Builder(this);
                ...
                alertbox.setPositiveButton("Yes", new DialogInterface.OnClickListener() 
                {
                    ...
                    {
                    	Task task = new Task();
                		task.applicationContext = AddTaskContactDetails.this;
                		task.execute();
	...
	return type:void
	date:29-6-11
	purpose:call update call list class*/
	public void call()
	{
		Intent intent=new Intent(this,UpdateStatusContactsDetails.class);
		Bundle bun=new Bundle();
		bun.putString("name",cid4);
		System.out.println("Task will .. "+cid4);
