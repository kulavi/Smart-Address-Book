...
public class DeleteCallList extends Activity implements OnItemClickListener,OnCheckedChangeListener  
{
	ListView lv1;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		ok.setOnClickListener(new OnClickListener() 
		{
			public void onClick(View v) 
			{
				...
				Intent i=new Intent(DeleteCallList.this,CallList.class);
				startActivity(i);
			}
  ...
  */
	...
	public void onItemClick(AdapterView<?> a, View v, int position, long id) 
	{
		...
		Cursor cursor=data.retCallId(ans);
		while(cursor.moveToNext())
		{
			id8=cursor.getInt(0);
			System.out.println("List idsssss "+id8);
		}
		cursor.close();
		lv1.clearChoices();
		data.deleteCallListName(id8);
