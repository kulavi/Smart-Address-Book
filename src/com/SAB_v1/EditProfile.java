		...
		smob.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==7)
						{
							 final Dialog dialog3 = new Dialog(EditProfile.this);
		...
		swork.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==7)
						{
							 final Dialog dialog1 = new Dialog(EditProfile.this);
		...
		soth.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==7)
						{
							 final Dialog dialog2 = new Dialog(EditProfile.this);
...
data.close();
	...
	public void updateuser(int contid)
	{
		data.updateuser(contid, sefn,seln,semno,smnoh1,smnow1,smnoo1,seemail,seemailw,seemailo,imagePath,setag);
		Toast t=Toast.makeText(getBaseContext(),"Profile Updated",Toast.LENGTH_LONG);
		t.show();

	}
	public void updateuser1(int contid1)
	{
	 	data.updateusermore(contid1,strwadd,strorgcw,strorgco,strorgpw,strorgpo,strorgcust,strcompadd, strnname, strpadd,strpaw,strpao,strpacust, strbirth, strani);
		...
		sorgw.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==3)
						{
							 final Dialog dialog5 = new Dialog(EditProfile.this);
		...
		sorgo.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==3)
						{
							 final Dialog dialog6 = new Dialog(EditProfile.this);
		...
		spah.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==3)
						{
							 final Dialog dialog4 = new Dialog(EditProfile.this);
		...
		spaw.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==2)
						{
							 final Dialog dialog7 = new Dialog(EditProfile.this);
		...
		spao.setOnItemSelectedListener(
				new AdapterView.OnItemSelectedListener() {
					public void onItemSelected(AdapterView<?> a,View view,int position,long id)
					{
						if(position==2)
						{
							 final Dialog dialog8 = new Dialog(EditProfile.this);
		 ...
		 viewLocation = new Runnable()
		   {
	        ...
	        thread.start();
	        m_ProgressDialog = ProgressDialog.show(EditProfile.this,    
	              "Smart Address Book", "Updating Profile........", true);
	...
	{
		Intent i=new Intent(EditProfile.this,AccountSettings.class);
		startActivity(i);
