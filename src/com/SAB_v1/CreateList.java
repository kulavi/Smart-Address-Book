...
{	
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		//get call list id
		Cursor c8=data.getDataCallid(listname1);
		while(c8.moveToNext())
		{
			id1=c8.getInt(0);
			System.out.println("Cll id......"+id1);
		...
		{      
			public void onClick(View v) 
			{
				...
				Task task = new Task();
        		task.applicationContext = CreateList.this;
        		task.execute();
	...
	public void call()
	{
		Toast.makeText(CreateList.this, "Contact already added to this CallList", Toast.LENGTH_LONG);
	}
	/*Type :Function
	name:searchtag
	return type:void
				  ...
				  String img=results3.get(position);
				  	...
				  	ch.setOnClickListener( new OnClickListener() 
				  	{
						...
						public void onClick(View v) 
						{
							...
							//Toast.makeText(CreateList.this, "Contact id and list id will "+id1+" "+callid1,Toast.LENGTH_SHORT).show();
