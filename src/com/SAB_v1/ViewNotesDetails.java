...
public class ViewNotesDetails extends Activity 
{	
	...
	{                       
		...
		setContentView(R.layout.gridnotes);
		setTitle("Notes");
	...
	public void addnote()
	{
		final Dialog dialog = new Dialog(ViewNotesDetails.this);
	...
	{
		Intent i=new Intent(ViewNotesDetails.this,ViewNotesDetails.class);
		Bundle bun33=new Bundle();
		bun33.putInt("inid",id1);
	...
	{
		Intent i=new Intent(ViewNotesDetails.this,ContactDetails.class);
		Bundle bun33=new Bundle();
