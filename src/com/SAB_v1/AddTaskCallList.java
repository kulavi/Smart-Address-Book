...
public class AddTaskCallList extends Activity implements OnClickListener
{
	DataBaseHelper data;
	EditText edescp,loc;
	ArrayAdapter adapter,adapter2,adapter3,adapter4;
	Spinner s,sp;
	String locname="",listid;
	GMailSender m;
	String cid4;
	...
	public void onCreate(Bundle icicle)
	{
		...
		listid=bundle.getString("name5");
		System.out.println("My Names: "+id);
		System.out.println("listid add: "+listid);
		...
		ddone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				if(flag==1)
				{
					...
					{
						final AlertDialog.Builder alertbox1=new AlertDialog.Builder(AddTaskCallList.this);
	                ...
	                // do something when the button is clicked
							public void onClick(DialogInterface arg0, int arg1)
							{
								...
								data.Inserttask(name3,taskname,descrip,ans,sdate,ddate,stime,cid,locname);
		          			    Toast.makeText(AddTaskCallList.this, "Task Added Successfully",Toast.LENGTH_SHORT).show();
		          		      ...
		          		      Intent i = new Intent(AddTaskCallList.this,DisplayNotification.class);
		          		      ...
		          		      alarmManager.set(AlarmManager.RTC_WAKEUP, 
		                    	 ...
		                    	 Intent i1 =new Intent(AddTaskCallList.this,UpdateStatusCallList.class);
		...
		protected void onPostExecute(Void unused) {
			...
			System.out.println("IN PostExecute");
		      ...
		      try { 
		        ...
		        if(m.send()) { 
		          Toast.makeText(AddTaskCallList.this, "Email was sent successfully.", Toast.LENGTH_LONG).show();
		          
		          } else { 
		          Toast.makeText(AddTaskCallList.this, "Email was not sent.", Toast.LENGTH_LONG).show(); 
		        } 
		      } catch(Exception e) { 
	...
	public void email_alert()
	{
		final AlertDialog.Builder alertbox=new AlertDialog.Builder(this);
                ...
                alertbox.setPositiveButton("Yes", new DialogInterface.OnClickListener() 
                {
                    ...
                    {
                    	Task task = new Task();
                		task.applicationContext = AddTaskCallList.this;
                		task.execute();
	...
	public void call()
	{
		Intent intent=new Intent(this,UpdateStatusCallList.class);
		Bundle bun=new Bundle();
		bun.putString("name",id);
		bun.putString("name3",listid);
