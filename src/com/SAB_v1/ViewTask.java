...
public class ViewTask extends Activity implements OnClickListener
	{
		...
		private static final String dateTemplate = "MMMM d yyyy";
		...
		public class GridCellAdapter extends BaseAdapter implements OnClickListener
			{
				...
				public void onClick(View view)
					{		String task="";
							...
							Cursor c=db.getTask(sdate1);
							int x= c.getCount();
							if(x==0)
							{                        
								                        
								                     
								Intent i=new Intent(ViewTask.this,AddTaskc.class);
								Bundle b=new Bundle();
							...
							else
							{
									...
									Intent i=new Intent(ViewTask.this,ViewTaskByDate.class);
									Bundle b=new Bundle();
				...
				public int getMonthAsNO(String mnth2)
				{
					int m=0;
		...
		{
			Intent i=new Intent(ViewTask.this,Main.class);
			startActivity(i);
			return;
		}
