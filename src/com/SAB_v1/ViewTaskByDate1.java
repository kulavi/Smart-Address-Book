...
public class ViewTaskByDate1 extends Activity 
{
	DataBaseHelper db;
	...
	{
		Intent i=new Intent(ViewTaskByDate1.this,ViewTask.class);
		startActivity(i);
		return;
	}
			...
			View v;
				...
				tv.setOnClickListener(new TextView.OnClickListener()
				{
					...
					public void onClick(View v) {                           
						...
						Intent i= new Intent(ViewTaskByDate1.this,Taskdetails.class);
